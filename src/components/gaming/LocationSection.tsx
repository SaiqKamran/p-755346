    ...
    <section className="flex flex-col items-center px-4 py-12 bg-indigo-900/50" ref={sectionRef}>
      ...
      <div className="w-full max-w-[1200px] grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="h-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden">
          <iframe 
            src={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3430.1123456789!2d76.79087265952258!3d30.74177739443509!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390fed87bc5a01f9%3A0xe3c3d2c5e23c47da!2sArena%20Animation%20Chandigarh%209!5e0!3m2!1sen!2sin!4v1713192140973!5m2!1sen!2sin`}
            width="100%" 
            height="100%" 
