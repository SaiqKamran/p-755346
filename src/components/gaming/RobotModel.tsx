  ...
  background: "linear-gradient(135deg, #0F0F0F 80%, #1A1A1A 100%)"
    ...
    <div className="flex justify-between items-center">
      ...
      <div className="w-1/4 space-y-6 pl-8">
        <motion.div className="bg-[#1A1A1A]/50 p-4 rounded-xl border border-yellow-400/20 backdrop-blur-sm hover:border-yellow-400/40 transition-all duration-300" initial={{
        opacity: 0,
        x: -20
      }} animate={{
        opacity: 1,
      ...
      <div className="w-2/4 h-[400px]">
        ...
        height: "100%"
          ...
          <OrbitControls enablePan={false} enableRotate={false} minDistance={2.2} maxDistance={8} />
        </Canvas>
      </div>
