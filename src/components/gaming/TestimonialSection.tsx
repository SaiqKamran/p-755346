        ...
        <div className="relative">
          <div className="flex animate-scroll-x">
            ...
            <div className="flex gap-6">
              {testimonials.map((testimonial, index) => <div key={`first-${index}`} className="w-[400px] flex-shrink-0">
            ...
            <div className="flex gap-6">
              {testimonials.map((testimonial, index) => <div key={`second-${index}`} className="w-[400px] flex-shrink-0">
                  <TestimonialCard {...testimonial} />
                </div>)}
            </div>
            ...
            <div className="flex gap-6">
              {testimonials.map((testimonial, index) => <div key={`third-${index}`} className="w-[400px] flex-shrink-0">
                  <TestimonialCard {...testimonial} />
                </div>)}
            </div>
          </div>
