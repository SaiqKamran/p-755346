  ...
  return <section className="flex flex-col items-center">
      <div className="w-full max-w-[1245px] max-md:max-w-full">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          {testimonials.map((testimonial, index) => <div key={index} className="w-6/12 max-md:w-full max-md:ml-0">
              <TestimonialCard {...testimonial} />
            </div>)}
        </div>
      </div>

      <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/556baeb13bc2087e937458e9a46c5622f0cb39ee?placeholderIfAbsent=true" className="aspect-[1] object-contain w-7 mt-[78px] rounded-[50%] max-md:mt-10" alt="Decorative dot" />
